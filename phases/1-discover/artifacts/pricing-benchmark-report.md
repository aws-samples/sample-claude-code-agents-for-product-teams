...
- [Competitive landscape report](competitive-landscape-report.md)
- [User personas](user-personas.md) and [validated problem statement](validated-problem-statement.md) for value framing
...
- Business Analyst — plugs per-unit value assumptions into the [ROI model](roi-model.md)
- Product Owner and Product Sponsor — use it to test commercial viability
- Sales & Marketing (future) — evolves it into the [pricing & packaging plan](../../../7-launch/artifacts/pricing-packaging-plan.md) at launch
