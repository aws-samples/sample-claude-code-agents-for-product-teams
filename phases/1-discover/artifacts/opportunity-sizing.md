...
- [Market analysis report](market-analysis-report.md) and [validated problem statement](validated-problem-statement.md)
- [User personas](user-personas.md) for volume and behavior assumptions
- [Pricing benchmark report](pricing-benchmark-report.md) for per-unit value
- Finance-approved discount rates and adoption curve conventions

## Who consumes it

- Business Analyst — feeds it into the [ROI model](roi-model.md) and [business case](business-case.md)
