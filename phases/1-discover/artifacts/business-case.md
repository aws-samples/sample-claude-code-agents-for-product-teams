...
- [ROI model](roi-model.md) and [ROI technical inputs](roi-technical-inputs.md)
- [Opportunity sizing](opportunity-sizing.md) and [market analysis report](market-analysis-report.md)
- [Pricing benchmark report](pricing-benchmark-report.md) and [competitive landscape report](competitive-landscape-report.md)
- [Feasibility memo](feasibility-memo.md) for cost and risk posture
