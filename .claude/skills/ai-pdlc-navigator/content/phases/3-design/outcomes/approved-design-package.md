...
_Produced by: Design review & sign-off_
...
Approval marks the UX as stable enough to build against. Without it, engineering builds a moving target and UI re-work dominates later phases.

## What it contains

- All UX artifacts at review-ready quality
- Accessibility conformance notes
- Open issues list, each with an owner and resolution plan

## Definition of Done

- [ ] All UX artifacts are at review-ready quality, not draft.
- [ ] Accessibility conformance notes are attached.
- [ ] Every open issue has a named owner and resolution plan.
- [ ] Design leadership and the Product Owner have signed off in writing.

## Entry criteria

- Design specs, visual design, prototype complete
- Usability findings integrated
- Accessibility design review done

## Exit signal

Engineering can reference the design package as the definition of the UI/UX surface.
